...
public class Worker implements Serializable {
    ...
    public Worker(Integer id, String owner, String name, Coordinates coordinates, LocalDateTime creationDate, int salary, ZonedDateTime endDate, Position position, Status status, Person person) {
        this.id = id;
        this.owner = owner;
        this.name = name;
        this.coordinates = coordinates;
