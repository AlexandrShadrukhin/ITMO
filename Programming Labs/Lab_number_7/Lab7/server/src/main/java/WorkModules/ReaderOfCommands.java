...
public class ReaderOfCommands implements WorkHistory {
    ...
    public Answer startReadCommands(Collection<Worker> collection, String path, Task task, DatabaseHandler databaseHandler) throws IOException, SQLException {
        TokenizatorOfCommands tokenizatorOfCommands = new TokenizatorOfCommands();
        ChooseCommand chooseCommand = new ChooseCommand(collection, databaseHandler);
